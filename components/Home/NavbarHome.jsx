...
const NavbarHome = () => {
  ...
  return (
    <>
      <nav class=" bg-secondary w-full flex relative justify-between items-center mx-auto px-8 h-20">
          ...
          <div class="flex justify-end items-center relative">
            <div class="flex mr-4 items-center">
              <div class="flex items-center relative cursor-pointer whitespace-nowrap">
                <img src="https://source.unsplash.com/1200x2400?woman" className="h-10 w-10 rounded-full hover:scale-110 duration-500" alt="/" />
              </div>
            </div>
          </div>
        </div>
